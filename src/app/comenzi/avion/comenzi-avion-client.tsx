...
import type { ComandaAvion } from "@prisma/client";
...
const fields: ComenziFieldDef[] = [
  ...
  { key: "awb", label: "AWB (lasă gol dacă nu există încă)", type: "text" },
...
export function ComenziAvionClient({ initialRows }: { initialRows: ComandaAvion[] }) {
  const [rows, setRows] = useState<ComandaAvion[]>(initialRows);
